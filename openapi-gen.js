...
const platformPaths = {
  '/v1/auth/signup': { post: { summary: 'Create account', tags: ['Auth'], security: [], requestBody: { content: { 'application/json': { schema: { type: 'object', required: ['email', 'password'], properties: { email: { type: 'string' }, password: { type: 'string' } } } } } }, responses: { '200': { description: 'Account created with API key and 2,000 free credits' } } } },
