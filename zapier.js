 ...
 *   - /zapier/actions        - list available actions (all 1,049 APIs)
...
module.exports = function mountZapier(app, allHandlers, API_DEFS, apiKeys, auth) {
  ...
  app.get('/zapier/app.json', (req, res) => {
    ...
    res.json({
      ...
      key: 'slopshop',
      name: 'Slopshop',
      description: 'The API bazaar for AI agents. 1,049 real APIs - text processing, crypto, AI content, network tools, and more.',
