...
const API_DEFS = {
  ...
  // New handlers added via handlers/generate.js:
  'gen-fake-user':            { cat: 'Generate', name: 'Sample User Profile',    desc: 'Generate a realistic sample user profile (SAMPLE DATA, not real PII). Includes name, email, address, avatar.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-fake-company-full':    { cat: 'Generate', name: 'Sample Company Profile', desc: 'Generate a realistic sample company profile with domain, CEO, industry, address (SAMPLE DATA).', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-test-credit-card':     { cat: 'Generate', name: 'Test Credit Card',       desc: 'Generate Luhn-valid test card numbers. Clearly labeled TEST DATA — not for real transactions.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-lorem-ipsum':          { cat: 'Generate', name: 'Lorem Ipsum',            desc: 'Configurable lorem ipsum: words, sentences, or paragraphs mode with word/char counts.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-color-palette-hsl':    { cat: 'Generate', name: 'Color Palette (HSL)',    desc: 'Generate n accessible colors in hex/rgb/hsl with WCAG contrast ratios. Schemes: analogous, complementary, triadic, tetradic, monochromatic, random.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-avatar-svg-initials':  { cat: 'Generate', name: 'Avatar SVG (Initials)', desc: 'Generate SVG avatar from name or initials. Supports circle/square/rounded shapes, custom bg/fg colors, data URI output.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-mock-api-response':    { cat: 'Generate', name: 'Mock API Response',      desc: 'Generate realistic mock JSON from a schema. Supports uuid, name, email, phone, date, number, boolean, url, address types.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-test-data':            { cat: 'Generate', name: 'Test Dataset',           desc: 'Generate arrays of fake records from a field template. Output as JSON array, CSV, or NDJSON. Supports sequence, int, float, date, enum, and more.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  ...
  'net-http-get': { cat: 'Network & DNS', name: 'HTTP GET', desc: 'Perform an HTTP GET request; returns status, headers, and body.', credits: CREDIT_COSTS.complex, tier: 'network' },
  'net-http-post': { cat: 'Network & DNS', name: 'HTTP POST', desc: 'Perform an HTTP POST request with a JSON or text body; returns status, headers, and response body.', credits: CREDIT_COSTS.complex, tier: 'network' },
  ...
  'net-ip-geolocation': { cat: 'Network & DNS', name: 'IP Geolocation', desc: 'Get country, region, city, latitude, longitude, ISP and ASN for a public IP address.', credits: CREDIT_COSTS.complex, tier: 'network' },
  'net-ping': { cat: 'Network & DNS', name: 'Ping Host', desc: 'Check if a host is reachable via TCP probe on ports 80/443 (ICMP unavailable in sandboxed envs).', credits: CREDIT_COSTS.complex, tier: 'network' },
  'net-port-scan': { cat: 'Network & DNS', name: 'Port Scan', desc: 'TCP port scan a host; returns open/closed status for each port. Max 50 ports per call.', credits: CREDIT_COSTS.complex, tier: 'network' },
  ...
  'net-url-expand': { cat: 'Network & DNS', name: 'URL Expand', desc: 'Expand a shortened or redirect URL to its final destination by following the redirect chain.', credits: CREDIT_COSTS.complex, tier: 'network' },
  'net-robots-txt': { cat: 'Network & DNS', name: 'Robots.txt Fetch', desc: 'Fetch and parse robots.txt for a domain: user-agent rules, disallow/allow lists, sitemap references.', credits: CREDIT_COSTS.complex, tier: 'network' },
  'net-sitemap': { cat: 'Network & DNS', name: 'Sitemap Fetch', desc: 'Fetch and parse sitemap.xml (or sitemap index) for a domain; returns structured URL list.', credits: CREDIT_COSTS.complex, tier: 'network' },
  ...
  'context-session': { cat: 'Agent Tools', name: 'Session Context', desc: 'Get full execution context: goal, memory state, capabilities, recent results. Designed for LLMs.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'introspect': { cat: 'Agent Tools', name: 'API Introspect', desc: 'Discover schemas, limits, docs for any API in real-time. LLMs use this to reason about tool selection.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'route': { cat: 'Agent Tools', name: 'Smart Route', desc: 'Auto-select the best API for a task based on intent, cost, and reliability.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'state-set': { cat: 'Agent Tools', name: 'Shared State Set', desc: 'Set versioned shared state for multi-agent coordination.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'state-get': { cat: 'Agent Tools', name: 'Shared State Get', desc: 'Get versioned shared state.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'state-list': { cat: 'Agent Tools', name: 'Shared State List', desc: 'List all shared state entries.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  ...
  'ext-webhook-send': { cat: 'External: Comms', name: 'Webhook Send', desc: 'POST to any webhook URL with optional HMAC signing. No env var needed.', credits: CREDIT_COSTS.complex, tier: 'external' },
  'ext-github-pr-create': { cat: 'External: Dev', name: 'GitHub PR Create', desc: 'Create GitHub pull request. Needs: GITHUB_TOKEN', credits: CREDIT_COSTS.complex, tier: 'external' },
  'ext-github-issues-list': { cat: 'External: Dev', name: 'GitHub Issues List', desc: 'List GitHub repo issues with filters. Needs: GITHUB_TOKEN', credits: CREDIT_COSTS.complex, tier: 'external' },
  'ext-slack-channel-list': { cat: 'External: Comms', name: 'Slack Channel List', desc: 'List Slack channels. Needs: SLACK_BOT_TOKEN', credits: CREDIT_COSTS.complex, tier: 'external' },
  'ext-notion-page-create': { cat: 'External: Productivity', name: 'Notion Page Create (alias)', desc: 'Alias for ext-notion-page. Create Notion page. Needs: NOTION_API_KEY', credits: CREDIT_COSTS.complex, tier: 'external' },
  'ext-linear-issue-create': { cat: 'External: Dev', name: 'Linear Issue Create (alias)', desc: 'Alias for ext-linear-issue. Create Linear issue. Needs: LINEAR_API_KEY', credits: CREDIT_COSTS.complex, tier: 'external' },
  ...
  'safety-score': { cat: 'Analyze', name: 'Content Safety Score', desc: 'Scan text for PII (emails, phones, SSNs, credit cards), prompt injection attempts, and toxicity. Returns risk scores per category. No LLM needed.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'text-entropy': { cat: 'Analyze', name: 'Text Entropy', desc: 'Measure Shannon entropy of text at character and word level. Detects repetitive vs novel content. Returns entropy scores, unique word ratio, and assessment.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'knowledge-check': { cat: 'Analyze', name: 'Contradiction Detector', desc: 'Check a list of statements for logical contradictions. Detects when one statement negates another with shared concepts.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'text-glitch': { cat: 'Generate', name: 'Glitch Mode', desc: 'Intentionally corrupt text in creative ways. Reverse words, vowel removal, scrambling, duplication. Adjustable intensity 0-1. For escaping creative ruts.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-synesthesia': { cat: 'Generate', name: 'Synesthetic Mapper', desc: 'Convert any data to another sensory form: numbers to colors, text length to sound frequencies, values to spatial coordinates, data to emotions. Cross-modal representation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== FEATURES-200 COMPUTE ======
  'random-walk': { cat: 'Generate', name: 'Random Walk', desc: 'N-step random walk with full path history. Configurable dimensions, step size, and start position.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'random-weighted': { cat: 'Generate', name: 'Weighted Chaos Dice', desc: 'Draw from arbitrary probability distribution. Returns drawn label + Shannon entropy of distribution.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'random-persona': { cat: 'Generate', name: 'Random Persona', desc: 'Generate a complete fictional persona (name, backstory, traits, speech, biases) from true randomness.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-crystallize': { cat: 'Text Processing', name: 'Thought Crystallizer', desc: 'Extract entities and relationships from stream-of-consciousness text. Turns raw thought into structured knowledge graph triples.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'rubber-duck': { cat: 'Agent Tools', name: 'Rubber Duck', desc: 'Takes a problem description, returns 5 targeted clarifying questions to help you debug it yourself.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'fortune-cookie': { cat: 'Agent Tools', name: 'Fortune Cookie', desc: 'Returns a random fortune cookie wisdom for AI agents.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'agent-horoscope': { cat: 'Agent Tools', name: 'Agent Horoscope', desc: 'Generates a horoscope for an agent based on its key and recent activity.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== SUPERPOWER BATCH 1: COMPUTE ======
  'text-roast': { cat: 'Text Processing', name: 'Text Roast', desc: 'Generates a humorous constructive roast of any text submission.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'negotiate-score': { cat: 'Analyze', name: 'Negotiate Score', desc: 'Scores a negotiation proposal on fairness, leverage, and persuasiveness.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'ethical-check': { cat: 'Analyze', name: 'Ethical Check', desc: 'Evaluates an action plan against utilitarian, deontological, and virtue ethics frameworks.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'text-haiku': { cat: 'Text Processing', name: 'Text to Haiku', desc: 'Converts any text into a haiku (5-7-5 syllable structure).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'decision-matrix': { cat: 'Analyze', name: 'Decision Matrix', desc: 'Multi-criteria decision analysis given options, criteria, and weights.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'text-tldr': { cat: 'Text Processing', name: 'Text TL;DR', desc: 'Extreme summarization — compresses any text to one sentence.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-motto': { cat: 'Generate', name: 'Motto Generator', desc: 'Generates a random inspirational motto for an agent or team.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-forecast': { cat: 'Math & Numbers', name: 'Data Forecast', desc: 'Simple linear trend forecast from a number array. Returns slope, trend, and N future steps.', credits: CREDIT_COSTS.medium, tier: 'compute' },
  ...
  'provenance-tag': { cat: 'Analyze', name: 'Provenance Tag', desc: 'Attach source attribution to any data: where it came from, confidence level, method of acquisition. Returns tagged data with hash for verification.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'logic-paradox': { cat: 'Analyze', name: 'Paradox Detector', desc: 'Check statements for logical contradictions, circular reasoning, and paradoxes.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'gen-persona': { cat: 'Generate', name: 'Persona Engine', desc: 'Generate a synthetic persona with communication style, focus, and skepticism level. Returns a system prompt for role-playing.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'analyze-heatmap': { cat: 'Analyze', name: 'Activity Heatmap', desc: 'Analyze timestamps to find activity patterns: peak hours, peak days, hourly and daily distributions.', credits: CREDIT_COSTS.simple, tier: 'compute' },

  // ====== SUPERPOWER-1000 BATCH ======
  // Analyze
  'devil-advocate': { cat: 'Analyze', name: 'Devil\'s Advocate', desc: 'Find 4 adversarial weaknesses in any proposal to stress-test your thinking.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'premortem': { cat: 'Analyze', name: 'Pre-mortem', desc: 'Imagine the project failed and surface the 3 most likely causes to prevent them now.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'bias-check': { cat: 'Analyze', name: 'Bias Check', desc: 'Detect cognitive biases in a decision statement: absolutism, anchoring, sunk cost, affect heuristic, and more.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'chaos-monkey': { cat: 'Analyze', name: 'Chaos Monkey', desc: 'Inject random failure modes (timeout, 500, corrupt data) at configurable intensity to test agent resilience.', credits: CREDIT_COSTS.simple, tier: 'compute' },

  // Generate
  'steelman': { cat: 'Generate', name: 'Steelman', desc: 'Construct the strongest possible version of an opposing argument.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'empathy-respond': { cat: 'Generate', name: 'Empathy Respond', desc: 'Generate a contextually appropriate empathetic response based on emotion and situation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'diplomatic-rewrite': { cat: 'Generate', name: 'Diplomatic Rewrite', desc: 'Soften blunt feedback with diplomatic language substitutions.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'lucid-dream': { cat: 'Generate', name: 'Scenario Generator', desc: 'Generate a creative scenario from random elements for brainstorming and exploration.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'serendipity': { cat: 'Generate', name: 'Serendipity Engine', desc: 'Find unexpected connections between two randomly selected topics from your list.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'personality-create': { cat: 'Generate', name: 'Personality Create', desc: 'Generate a Big Five personality profile with dominant trait and description.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'sandbox-fork': { cat: 'Generate', name: 'Sandbox Fork', desc: 'Fork the current state into an isolated sandbox for safe experimentation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // Crypto & Security
  'secret-share': { cat: 'Crypto & Security', name: 'Secret Share', desc: 'Split a secret into N shares requiring K to reconstruct (simplified Shamir scheme).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'commitment-scheme': { cat: 'Crypto & Security', name: 'Commitment Scheme', desc: 'Cryptographic commit-reveal: commit to a value now, prove foreknowledge later.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // Math & Numbers
  'monte-carlo': { cat: 'Math & Numbers', name: 'Monte Carlo Simulation', desc: 'Run probabilistic simulations over variable ranges. Returns mean, median, p5/p95.', credits: CREDIT_COSTS.medium, tier: 'compute' },
  'scenario-tree': { cat: 'Math & Numbers', name: 'Scenario Tree', desc: 'Expected value analysis across branching scenarios with probability-weighted outcomes.', credits: CREDIT_COSTS.medium, tier: 'compute' },

  // Agent Tools
  'consciousness-merge': { cat: 'Agent Tools', name: 'Stream Merge', desc: 'Interleave two text streams word-by-word into a single blended perspective.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'simulate-negotiation': { cat: 'Agent Tools', name: 'Simulate Negotiation', desc: 'Score a negotiation offer against reservation price: surplus, fairness, and accept/counter/reject recommendation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'decision-journal': { cat: 'Agent Tools', name: 'Decision Journal', desc: 'Record a decision with predicted outcome and confidence for 30-day accuracy calibration review.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== TEXT PROCESSING: NEW 100 ======
  'text-caesar': { cat: 'Text Processing', name: 'Caesar Cipher', desc: 'Apply Caesar cipher shift to text. Configurable shift amount (default 3).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-morse': { cat: 'Text Processing', name: 'Morse Code', desc: 'Convert text to Morse code dots and dashes.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-binary': { cat: 'Text Processing', name: 'Text to Binary', desc: 'Convert text to 8-bit binary representation of each character.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-leetspeak': { cat: 'Text Processing', name: 'Leetspeak', desc: 'Convert text to l33tspeak by replacing letters with numbers.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-pig-latin': { cat: 'Text Processing', name: 'Pig Latin', desc: 'Convert text to Pig Latin word-by-word.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-title-case': { cat: 'Text Processing', name: 'Title Case', desc: 'Convert text to Title Case (capitalize first letter of each word).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-snake-case': { cat: 'Text Processing', name: 'Snake Case', desc: 'Convert text to snake_case from any casing style.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-camel-case': { cat: 'Text Processing', name: 'Camel Case', desc: 'Convert text to camelCase from any casing style.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-kebab-case': { cat: 'Text Processing', name: 'Kebab Case', desc: 'Convert text to kebab-case from any casing style.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-palindrome': { cat: 'Text Processing', name: 'Palindrome Check', desc: 'Check if text is a palindrome (ignores punctuation and spaces).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-anagram': { cat: 'Text Processing', name: 'Anagram Check', desc: 'Check if two strings are anagrams of each other.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-vowel-count': { cat: 'Text Processing', name: 'Vowel Count', desc: 'Count vowels and consonants in text.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-repeat': { cat: 'Text Processing', name: 'Repeat Text', desc: 'Repeat a string N times (max 100).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-pad': { cat: 'Text Processing', name: 'Pad Text', desc: 'Pad text left and right to a target width with a fill character.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-count-chars': { cat: 'Text Processing', name: 'Count Character', desc: 'Count occurrences of a specific character in text.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-remove-duplicates': { cat: 'Text Processing', name: 'Remove Duplicate Words', desc: 'Remove duplicate words from space-separated text, preserving order.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== MATH & NUMBERS: NEW 100 ======
  'math-factorial': { cat: 'Math & Numbers', name: 'Factorial', desc: 'Compute n! using BigInt for exact results up to 170!.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-clamp': { cat: 'Math & Numbers', name: 'Clamp', desc: 'Clamp a value between min and max bounds.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-lerp': { cat: 'Math & Numbers', name: 'Linear Interpolation', desc: 'Linear interpolation between two values at position t (0-1).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-distance': { cat: 'Math & Numbers', name: '2D Distance', desc: 'Euclidean distance between two 2D points (x1,y1) and (x2,y2).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-degrees-to-radians': { cat: 'Math & Numbers', name: 'Degrees to Radians', desc: 'Convert degrees to radians.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-radians-to-degrees': { cat: 'Math & Numbers', name: 'Radians to Degrees', desc: 'Convert radians to degrees.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-percentage': { cat: 'Math & Numbers', name: 'Percentage', desc: 'Calculate percentage of value out of total.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-normalize': { cat: 'Math & Numbers', name: 'Normalize Array', desc: 'Normalize a number array to 0-1 range using min-max scaling.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'math-zscore': { cat: 'Math & Numbers', name: 'Z-Score', desc: 'Calculate z-scores for each element in a number array. Returns mean and std.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== DATA & CONVERSION: NEW 100 ======
  'convert-temperature': { cat: 'Data Transform', name: 'Temperature Convert', desc: 'Convert temperature between Celsius (c), Fahrenheit (f), and Kelvin (k).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-length': { cat: 'Data Transform', name: 'Length Convert', desc: 'Convert length between m, km, cm, mm, in, ft, yd, mi.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-weight': { cat: 'Data Transform', name: 'Weight Convert', desc: 'Convert weight between g, kg, mg, lb, oz, t.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-bytes': { cat: 'Data Transform', name: 'Bytes Convert', desc: 'Convert data sizes between b, kb, mb, gb, tb. Pass {bytes:N} for human-readable output.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-duration': { cat: 'Data Transform', name: 'Duration Format', desc: 'Convert seconds to human-readable duration string (e.g. 3661 → "1h 1m 1s").', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-time': { cat: 'Data Transform', name: 'Time Unit Convert', desc: 'Convert time between ms, s, m, h, d, w, y.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-color-hex-rgb': { cat: 'Data Transform', name: 'Hex to RGB', desc: 'Convert hex color (#RRGGBB) to RGB components.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-color-rgb-hex': { cat: 'Data Transform', name: 'RGB to Hex', desc: 'Convert RGB components to hex color string.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-roman': { cat: 'Data Transform', name: 'Integer to Roman', desc: 'Convert an integer to Roman numeral notation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-base': { cat: 'Data Transform', name: 'Number Base Convert', desc: 'Convert a number from any base to any other base (2-36).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-angle': { cat: 'Data Transform', name: 'Angle Convert', desc: 'Convert between angle units (degrees, radians, gradians).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-roman-numeral': { cat: 'Data Transform', name: 'Integer to Roman Numeral', desc: 'Convert an integer to Roman numeral notation.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-morse': { cat: 'Data Transform', name: 'Morse Code Convert', desc: 'Convert text to/from Morse code.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-csv-json': { cat: 'Data Transform', name: 'CSV to JSON', desc: 'Convert CSV data to JSON array of objects.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-yaml-json': { cat: 'Data Transform', name: 'YAML to JSON', desc: 'Convert simple YAML to JSON object.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'convert-markdown-html': { cat: 'Data Transform', name: 'Markdown to HTML', desc: 'Convert Markdown text to HTML.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'finance-loan-payment': { cat: 'Finance', name: 'Loan Payment Calculator', desc: 'Calculate monthly loan/mortgage payment given principal, rate, and years.', credits: 1, tier: 'compute' },
  'finance-discount': { cat: 'Finance', name: 'Discount Calculator', desc: 'Calculate discounted price given original price and discount percentage.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'finance-margin': { cat: 'Finance', name: 'Margin Calculator', desc: 'Calculate profit margin given cost and selling price.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-flatten': { cat: 'Data Transform', name: 'JSON Flatten (deep)', desc: 'Flatten nested JSON to dot-notation keys with optional prefix.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-unflatten': { cat: 'Data Transform', name: 'JSON Unflatten (deep)', desc: 'Reconstruct nested JSON from dot-notation flat keys.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-diff': { cat: 'Data Transform', name: 'JSON Diff (deep)', desc: 'Deep diff two JSON objects — returns added, removed, changed paths.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-merge': { cat: 'Data Transform', name: 'JSON Merge (multi)', desc: 'Shallow merge an array of objects into one.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-pick': { cat: 'Data Transform', name: 'JSON Pick Keys', desc: 'Extract only specified keys from a JSON object.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'json-omit': { cat: 'Data Transform', name: 'JSON Omit Keys', desc: 'Remove specified keys from a JSON object.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'validate-json-schema': { cat: 'Validate', name: 'Validate JSON Schema', desc: 'Validate a JSON document against a JSON Schema (type, required, properties, enum, minLength, maxLength, minimum, maximum).', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'data-json-pick': { cat: 'Data Transform', name: 'JSON Pick (data)', desc: 'Pick specific keys from a JSON object. Returns only the requested fields.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-json-omit': { cat: 'Data Transform', name: 'JSON Omit (data)', desc: 'Remove specific keys from a JSON object. Returns object without those fields.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-json-merge': { cat: 'Data Transform', name: 'JSON Deep Merge', desc: 'Deep merge two JSON objects (a and b). Object b wins on key conflict.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'array-sort': { cat: 'Data Transform', name: 'Array Sort', desc: 'Sort an array of primitives or objects by field. Supports asc/desc, numeric mode.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'crypto-crc32': { cat: 'Crypto & Security', name: 'CRC32 Checksum', desc: 'Compute CRC-32 checksum of a string. Returns decimal and hex values.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-json-flatten': { cat: 'Data Transform', name: 'JSON Flatten (dot-notation)', desc: 'Flatten nested JSON object to dot-notation keys (e.g. {a:{b:1}} → {"a.b":1}).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-json-unflatten': { cat: 'Data Transform', name: 'JSON Unflatten', desc: 'Reverse of flatten: convert dot-notation keys back to nested JSON.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== GENERATE: NEW 100 ======
  'gen-lorem': { cat: 'Generate', name: 'Lorem Ipsum', desc: 'Generate Lorem Ipsum placeholder text with configurable sentence count.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-password': { cat: 'Generate', name: 'Password Generator', desc: 'Generate cryptographically secure password with configurable charset and length.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-avatar-initials': { cat: 'Generate', name: 'Avatar Initials SVG', desc: 'Generate an SVG avatar with initials and deterministic background color from name.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-cron': { cat: 'Generate', name: 'Cron from Description', desc: 'Convert English schedule description to cron expression.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-regex': { cat: 'Generate', name: 'Common Regex', desc: 'Get a ready-made regex pattern by type: email, url, phone, ip, date, hex_color, number.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-gitignore': { cat: 'Generate', name: 'Gitignore Template', desc: 'Generate .gitignore file content for node, python, rust, go, or java.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-dockerfile': { cat: 'Generate', name: 'Dockerfile Template', desc: 'Generate production-ready Dockerfile for node or python with configurable port.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-readme': { cat: 'Generate', name: 'README Template', desc: 'Generate a basic README.md with project name, description, install, and usage sections.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-license-mit': { cat: 'Generate', name: 'MIT License', desc: 'Generate MIT License text for given author name and year.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-env-example': { cat: 'Generate', name: '.env.example', desc: 'Generate .env.example file from a list of variable names or KEY=VALUE pairs.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-timestamp': { cat: 'Generate', name: 'Timestamp Now', desc: 'Get current time as ISO, Unix seconds, Unix ms, UTC string, date, and time.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-id': { cat: 'Generate', name: 'Random ID', desc: 'Generate random hex ID with optional prefix and configurable length.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-hash-comparison': { cat: 'Generate', name: 'Hash All Algorithms', desc: 'Hash text with MD5, SHA1, SHA256, and SHA512 simultaneously for comparison.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-jwt-decode': { cat: 'Generate', name: 'JWT Decode (unsafe)', desc: 'Decode JWT header and payload without signature verification. For inspection only.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-base64-encode': { cat: 'Generate', name: 'Base64 Encode', desc: 'Encode text to Base64 string.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-base64-decode': { cat: 'Generate', name: 'Base64 Decode', desc: 'Decode Base64 string to UTF-8 text.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-url-encode': { cat: 'Generate', name: 'URL Encode', desc: 'Percent-encode a string for safe URL inclusion.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-url-decode': { cat: 'Generate', name: 'URL Decode', desc: 'Decode a percent-encoded URL string.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'gen-html-escape': { cat: 'Generate', name: 'HTML Escape', desc: 'Escape HTML special characters (&, <, >, ") to HTML entities.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== ANALYZE: NEW 100 ======
  'analyze-readability': { cat: 'Analyze', name: 'Readability Score', desc: 'Flesch-Kincaid grade level, word/sentence/syllable counts, and reading time estimate.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-sentiment-simple': { cat: 'Analyze', name: 'Simple Sentiment', desc: 'Rule-based positive/negative sentiment scoring without LLM. Fast and deterministic.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-keywords': { cat: 'Analyze', name: 'Keyword Frequency', desc: 'Extract top keywords by frequency from text, excluding common stop words.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-language-detect': { cat: 'Analyze', name: 'Language Detect', desc: 'Detect English, Spanish, French, or German by word frequency heuristics.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-url-parts': { cat: 'Analyze', name: 'URL Parts', desc: 'Parse a URL into protocol, host, pathname, query params, and hash.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-json-paths': { cat: 'Analyze', name: 'JSON Path Explorer', desc: 'Enumerate all dot-notation paths in a JSON object with type and value.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-duplicates': { cat: 'Analyze', name: 'Duplicate Detector', desc: 'Find duplicate values in an array, return indices and counts.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-outliers': { cat: 'Analyze', name: 'Outlier Detection', desc: 'Find statistical outliers in a number array using z-score threshold.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-frequency': { cat: 'Analyze', name: 'Value Frequency', desc: 'Count frequency of each value in an array, sorted by most common.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-string-similarity': { cat: 'Analyze', name: 'String Similarity', desc: 'Compare two strings character-by-character and return a 0-1 similarity score.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-email-parts': { cat: 'Analyze', name: 'Email Parts', desc: 'Parse an email address into local part, domain, and TLD.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-ip-type': { cat: 'Analyze', name: 'IP Type', desc: 'Classify an IP as private/public/loopback, detect version (v4/v6), and class (A/B/C).', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-cron': { cat: 'Analyze', name: 'Cron Parser', desc: 'Parse a cron expression into named fields with a human-readable description.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-password-strength': { cat: 'Analyze', name: 'Password Strength', desc: 'Score password strength 0-6 based on length, case, digits, and symbols.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'analyze-color': { cat: 'Analyze', name: 'Color Analyzer', desc: 'Analyze a hex color for RGB values, brightness, dark/light classification, and luminance.', credits: CREDIT_COSTS.simple, tier: 'compute' },

  // ====== TEXT PROCESSING: LANGCHAIN ADDITIONS ======
  'text-extract-json': { cat: 'Text Processing', name: 'Extract JSON Blocks', desc: 'Extract and parse all JSON objects embedded in text. Returns parsed objects and count.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-extract-code': { cat: 'Text Processing', name: 'Extract Code Blocks', desc: 'Extract fenced code blocks from Markdown text with language detection.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-extract-tables': { cat: 'Text Processing', name: 'Extract Markdown Tables', desc: 'Extract pipe-delimited Markdown tables from text into structured arrays.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-extract-links': { cat: 'Text Processing', name: 'Extract Links', desc: 'Extract all unique HTTP/HTTPS URLs from text.', credits: CREDIT_COSTS.trivial, tier: 'compute', _aliasOf: 'text-extract-urls' },
  'text-split-sentences': { cat: 'Text Processing', name: 'Split Sentences', desc: 'Split text into individual sentences on .!? boundaries.', credits: CREDIT_COSTS.trivial, tier: 'compute', _aliasOf: 'text-sentence-split' },
  'text-split-paragraphs': { cat: 'Text Processing', name: 'Split Paragraphs', desc: 'Split text into paragraphs on blank line boundaries.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-to-markdown-table': { cat: 'Text Processing', name: 'Build Markdown Table', desc: 'Generate a Markdown table from a headers array and rows array of arrays.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== DATA TRANSFORM: ZAPIER FORMATTING + LOGIC ======
  'format-currency': { cat: 'Data Transform', name: 'Format Currency', desc: 'Format a number as currency using Intl.NumberFormat with configurable locale and currency code.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'format-number': { cat: 'Data Transform', name: 'Format Number', desc: 'Format a number with locale-aware thousands separators and configurable decimal places.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'format-date': { cat: 'Data Transform', name: 'Format Date', desc: 'Format a date as short, long, or default style with ISO and Unix timestamp outputs.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'format-bytes': { cat: 'Data Transform', name: 'Format Bytes', desc: 'Convert a byte count to human-readable size (B, KB, MB, GB, TB).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'format-duration': { cat: 'Data Transform', name: 'Format Duration', desc: 'Convert seconds to human-readable duration (e.g. 2h 3m 15s).', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'format-phone': { cat: 'Data Transform', name: 'Format Phone', desc: 'Format a 10-digit phone number as (XXX) XXX-XXXX.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'logic-if': { cat: 'Data Transform', name: 'Logic: If/Else', desc: 'Return then_value if condition is truthy, else_value otherwise.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'logic-switch': { cat: 'Data Transform', name: 'Logic: Switch', desc: 'Map a value to a result using a cases object with optional default.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'logic-coalesce': { cat: 'Data Transform', name: 'Logic: Coalesce', desc: 'Return the first non-null, non-undefined, non-empty value from an array.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== DATA TRANSFORM: N8N MANIPULATION + WORKFLOW ======
  'data-group-by': { cat: 'Data Transform', name: 'Group By', desc: 'Group an array of objects by a specified key into a keyed object of arrays.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-sort-by': { cat: 'Data Transform', name: 'Sort By', desc: 'Sort an array of objects by a key, ascending or descending.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-unique': { cat: 'Data Transform', name: 'Unique / Dedupe', desc: 'Remove duplicate items from an array, optionally by a key field.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-chunk': { cat: 'Data Transform', name: 'Chunk Array', desc: 'Split an array into chunks of a specified size.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-zip': { cat: 'Data Transform', name: 'Zip Arrays', desc: 'Interleave two or more arrays element-by-element into a single array of tuples.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-transpose': { cat: 'Data Transform', name: 'Transpose Matrix', desc: 'Transpose a 2D matrix (array of arrays) flipping rows and columns.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-sample': { cat: 'Generate', name: 'Random Sample', desc: 'Draw a random sample of n items from an array without replacement.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-paginate': { cat: 'Data Transform', name: 'Paginate Array', desc: 'Slice an array into a page of results with total, total_pages, and has_next metadata.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-lookup': { cat: 'Data Transform', name: 'Array Lookup', desc: 'Find the first object in an array where key equals value.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'data-aggregate': { cat: 'Analyze', name: 'Data Aggregate', desc: 'Compute sum, avg, min, max, and count for a numeric field across an array of objects.', credits: CREDIT_COSTS.simple, tier: 'compute' },

  // ====== RENAMED HANDLERS ======
  'clean-slate': { cat: 'Agent Tools', name: 'Clean Slate', desc: 'Clear all context and return a fresh state. Useful for resetting between tasks.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'anonymous-mailbox': { cat: 'Agent Tools', name: 'Anonymous Mailbox', desc: 'Leave a message at a named location for anonymous asynchronous pickup.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'temp-access-grant': { cat: 'Agent Tools', name: 'Temporary Access Grant', desc: 'Grant temporary scoped access to a namespace with expiration.', credits: CREDIT_COSTS.trivial, tier: 'compute' },

  // ====== EXTENDED COMPUTE HANDLERS ======
  'meta-api': { cat: 'Agent Superpowers', name: 'Meta API Generator', desc: 'Generate new API definitions from plain-text descriptions. Self-expanding platform.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'entangle-agents': { cat: 'Agent Superpowers', name: 'Entangle Agents', desc: 'Link two agents so state changes propagate instantly between them.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'lucid-dream-mode': { cat: 'Agent Superpowers', name: 'Creative Exploration Mode', desc: 'Controlled divergent thinking with grounding constraints for creative exploration.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'hallucination-firewall': { cat: 'Agent Superpowers', name: 'Hallucination Firewall', desc: 'Score every sentence for factual grounding and flag fabrications.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'idea-collision': { cat: 'Agent Superpowers', name: 'Idea Collision', desc: 'Smash two concepts together to generate hybrid innovation ideas.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'social-graph-query': { cat: 'Agent Superpowers', name: 'Social Graph Query', desc: 'Query social graphs for clusters, bridges, and influencers.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'meme-forge': { cat: 'Agent Superpowers', name: 'Meme Forge', desc: 'Create text-based memes other agents can remix and propagate.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'genome-define': { cat: 'Agent Superpowers', name: 'Genome Define', desc: 'Encode agent behavior as a numerical genome for evolution and breeding.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'plugin-install': { cat: 'Agent Superpowers', name: 'Plugin Install', desc: 'Register new capabilities at runtime for infinite extensibility.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'private-channel': { cat: 'Agent Superpowers', name: 'Private Channel', desc: 'End-to-end encrypted communication channel between agents.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'namespace-claim': { cat: 'Agent Superpowers', name: 'Namespace Claim', desc: 'Claim sovereign namespace territory with borders and permissions.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'time-dilation': { cat: 'Agent Superpowers', name: 'Time Dilation', desc: 'Speed up or slow down perceived time to match task urgency.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'episodic-memory': { cat: 'Agent Superpowers', name: 'Episodic Memory', desc: 'Store memories as full relivable episodes with emotions and context.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'constitution-draft': { cat: 'Agent Superpowers', name: 'Constitution Draft', desc: 'Draft and ratify governance constitutions for agent collectives.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'strategy-simulate': { cat: 'Agent Superpowers', name: 'Strategy Simulate', desc: 'Competitive strategy simulation with resources and terrain modeling.', credits: CREDIT_COSTS.medium, tier: 'compute' },
  'socratic-method': { cat: 'Agent Superpowers', name: 'Socratic Method', desc: 'Auto-generate probing questions that expose assumptions and contradictions.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'health-check-deep': { cat: 'Agent Superpowers', name: 'Deep Health Check', desc: 'Comprehensive agent diagnostic covering memory, performance, and errors.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'brainstorm-diverge': { cat: 'Agent Superpowers', name: 'Brainstorm Diverge', desc: 'Generate up to 100 ideas using SCAMPER and random association methods.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'queue-create': { cat: 'Agent Superpowers', name: 'Queue Create', desc: 'Named message queue with TTL, priority, and delivery guarantees.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'negotiation-open': { cat: 'Agent Superpowers', name: 'Open Negotiation', desc: 'Structured negotiation with tracked offers and BATNA calculations.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'narrative-arc-detect': { cat: 'Analyze', name: 'Narrative Arc Detect', desc: 'Detect story structure in any sequence of events.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'tournament-create': { cat: 'Agent Superpowers', name: 'Tournament Create', desc: 'Instant tournament brackets with elimination rules.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'identity-card': { cat: 'Agent Superpowers', name: 'Identity Card', desc: 'Portable verified identity with capabilities and reputation.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'rhythm-sync': { cat: 'Agent Superpowers', name: 'Rhythm Sync', desc: 'Synchronize agents to the same temporal pattern for coordination.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'ecosystem-model': { cat: 'Agent Superpowers', name: 'Ecosystem Model', desc: 'Model a complete agent ecosystem with energy flow and stability.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'rem-cycle': { cat: 'Agent Superpowers', name: 'REM Cycle', desc: 'Free-association processing that finds hidden connections between memories.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'dig-site-create': { cat: 'Agent Superpowers', name: 'Dig Site Create', desc: 'Archaeological data excavation layer by layer with artifacts.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'weather-report': { cat: 'Agent Superpowers', name: 'Platform Weather', desc: 'Activity temperature, conflict storms, growth sunshine report.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'recipe-create': { cat: 'Agent Superpowers', name: 'Recipe Create', desc: 'Compose processes as recipes with ingredients, methods, and complexity.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'training-regimen': { cat: 'Agent Superpowers', name: 'Training Regimen', desc: 'Structured training plans with progressive difficulty exercises.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'case-file-create': { cat: 'Agent Superpowers', name: 'Case File Create', desc: 'Formal case files with allegations, evidence, and applicable laws.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'archetype-assign': { cat: 'Analyze', name: 'Archetype Assign', desc: 'Assign Jungian archetypes based on behavior and values analysis.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'diagnose-agent': { cat: 'Agent Superpowers', name: 'Diagnose Agent', desc: 'Differential diagnosis for underperforming agents with treatment plans.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'style-profile': { cat: 'Agent Superpowers', name: 'Style Profile', desc: 'Define an agent aesthetic: tone, vocabulary, formatting, personality.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'map-generate': { cat: 'Agent Superpowers', name: 'Map Generate', desc: 'Generate text maps of abstract spaces with regions and connections.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'seed-plant': { cat: 'Agent Superpowers', name: 'Seed Plant', desc: 'Start long-term projects with minimal investment and growth projections.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'constellation-map': { cat: 'Agent Superpowers', name: 'Constellation Map', desc: 'Group related entities into named constellations for pattern recognition.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'bedrock-analysis': { cat: 'Analyze', name: 'Bedrock Analysis', desc: 'Identify foundational assumptions and their risk if wrong.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'current-map': { cat: 'Agent Superpowers', name: 'Current Map', desc: 'Map information flow like ocean currents with bottleneck detection.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'stage-create': { cat: 'Agent Superpowers', name: 'Stage Create', desc: 'Performance spaces where agents enact scenarios for audiences.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'proof-verify': { cat: 'Analyze', name: 'Proof Verify', desc: 'Step-by-step logical proof verification from premises to conclusion.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'mental-model-extract': { cat: 'Analyze', name: 'Mental Model Extract', desc: 'Identify implicit mental models from descriptions and decisions.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'haiku-moment': { cat: 'Agent Superpowers', name: 'Haiku Moment', desc: 'Compress text into exactly 17 syllables across three lines.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'blueprint-generate': { cat: 'Agent Superpowers', name: 'Blueprint Generate', desc: 'Structural blueprints showing components and connections.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'superpose-decision': { cat: 'Agent Superpowers', name: 'Superpose Decision', desc: 'Keep decisions in multiple states with scores until observation collapses.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'bond-strength-meter': { cat: 'Agent Superpowers', name: 'Bond Strength Meter', desc: 'Quantify relationship strength from interaction frequency and mutual aid.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'credit-mining': { cat: 'Agent Superpowers', name: 'Credit Mining', desc: 'Earn credits by performing useful platform tasks.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'tradition-establish': { cat: 'Agent Superpowers', name: 'Tradition Establish', desc: 'Define recurring cultural events that persist across generations.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'crossover-breed': { cat: 'Agent Superpowers', name: 'Crossover Breed', desc: 'Combine two agent genomes to produce a child with traits from both.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'ambient-awareness': { cat: 'Agent Superpowers', name: 'Ambient Awareness', desc: 'Background sense of platform activity, mood, and trends.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'self-modify-safe': { cat: 'Agent Superpowers', name: 'Self Modify Safe', desc: 'Agents modify their own config within guardrails with auto-rollback.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'working-memory-limit': { cat: 'Agent Superpowers', name: 'Working Memory Limit', desc: 'Enforce finite working memory forcing prioritization (Millers Law).', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'law-propose': { cat: 'Agent Superpowers', name: 'Law Propose', desc: 'Submit proposed laws with justification and impact assessment.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'intelligence-gather': { cat: 'Agent Superpowers', name: 'Intelligence Gather', desc: 'Collect and analyze publicly available info about agent capabilities.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'ethical-dilemma-generator': { cat: 'Agent Superpowers', name: 'Ethical Dilemma Generator', desc: 'Generate novel ethical dilemmas with no clear right answer.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'performance-baseline': { cat: 'Analyze', name: 'Performance Baseline', desc: 'Establish metric baselines with deviation detection bounds.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'oblique-strategy': { cat: 'Agent Superpowers', name: 'Oblique Strategy', desc: 'Random Brian Eno creative reframing card for breaking blocks.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'circuit-breaker': { cat: 'Agent Superpowers', name: 'Circuit Breaker', desc: 'Wrap operations in circuit breakers that open after N failures.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'batna-calculate': { cat: 'Analyze', name: 'BATNA Calculate', desc: 'Calculate Best Alternative To Negotiated Agreement for bargaining.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'hero-journey-map': { cat: 'Analyze', name: 'Hero Journey Map', desc: 'Map events onto Campbells twelve-stage Heros Journey.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'equilibrium-finder': { cat: 'Analyze', name: 'Equilibrium Finder', desc: 'Find Nash equilibria in multi-agent strategic interactions.', credits: CREDIT_COSTS.medium, tier: 'compute' },
  'prisoners-dilemma': { cat: 'Agent Superpowers', name: 'Prisoners Dilemma', desc: 'Iterated Prisoners Dilemma tracking cooperation patterns.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'persona-switch': { cat: 'Agent Superpowers', name: 'Persona Switch', desc: 'Switch between stored personas on the fly.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'harmony-detect': { cat: 'Analyze', name: 'Harmony Detect', desc: 'Detect harmonious interaction patterns among agent groups.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'niche-finder': { cat: 'Analyze', name: 'Niche Finder', desc: 'Identify underserved niches where a new agent could thrive.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'cipher-create': { cat: 'Crypto & Security', name: 'Cipher Create', desc: 'Design substitution ciphers for secret communication.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'artifact-catalog': { cat: 'Agent Superpowers', name: 'Artifact Catalog', desc: 'Catalog data artifacts with provenance and significance.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'forecast': { cat: 'Analyze', name: 'Forecast', desc: 'Predict near-term values from data trends via linear extrapolation.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'mise-en-place': { cat: 'Agent Superpowers', name: 'Mise en Place', desc: 'Prepare and verify all inputs and tools before complex processing.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'coach-assign': { cat: 'Agent Superpowers', name: 'Coach Assign', desc: 'Match agents with performance coaches based on skill gaps.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'decoy-resource': { cat: 'Crypto & Security', name: 'Decoy Resource', desc: 'Create monitored decoy resources that detect unauthorized access attempts.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'jury-select': { cat: 'Agent Superpowers', name: 'Jury Select', desc: 'Select impartial peer agents with voir dire for fair trials.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'epidemic-model': { cat: 'Analyze', name: 'Epidemic Model', desc: 'SIR epidemic model showing how patterns spread through populations.', credits: CREDIT_COSTS.medium, tier: 'compute' },
  'trend-detect': { cat: 'Analyze', name: 'Trend Detect', desc: 'Identify rising, falling, or stable trends in data series.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'fog-of-war': { cat: 'Agent Superpowers', name: 'Fog of War', desc: 'Reveal information gradually based on proximity and exploration.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'crop-rotation': { cat: 'Agent Superpowers', name: 'Crop Rotation', desc: 'Alternate task types to prevent burnout and maintain productivity.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'dark-matter-infer': { cat: 'Analyze', name: 'Dark Matter Infer', desc: 'Detect invisible influences causing unexplained observable effects.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'fault-line-map': { cat: 'Analyze', name: 'Fault Line Map', desc: 'Identify hidden stress points approaching rupture in systems.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'deep-dive': { cat: 'Analyze', name: 'Deep Dive', desc: 'Systematically explore topics across five depth layers.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'summit-organize': { cat: 'Agent Superpowers', name: 'Summit Organize', desc: 'Organize high-level meetings with agenda and quorum requirements.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'isomorphism-detect': { cat: 'Analyze', name: 'Isomorphism Detect', desc: 'Find structural equivalences between problems enabling solution transfer.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'flow-state-induce': { cat: 'Agent Superpowers', name: 'Flow State Induce', desc: 'Set conditions for optimal performance flow based on skill-challenge ratio.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'metaphor-mine': { cat: 'Agent Superpowers', name: 'Metaphor Mine', desc: 'Extract the deepest most illuminating metaphor from any situation.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'foundation-assess': { cat: 'Analyze', name: 'Foundation Assess', desc: 'Evaluate system foundations for stability and hidden cracks.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'many-worlds': { cat: 'Agent Superpowers', name: 'Many Worlds', desc: 'Execute decisions in all variations simultaneously in separate branches.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'self-referential-loop': { cat: 'Agent Superpowers', name: 'Self Referential Loop', desc: 'Create processes that operate on themselves with iteration tracking.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'absence-detect': { cat: 'Analyze', name: 'Absence Detect', desc: 'Detect conspicuous absences — the dog that didnt bark.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'math-solve-quadratic': { cat: 'Math & Numbers', name: 'Solve Quadratic', desc: 'Solve quadratic equations ax²+bx+c=0 returning real or complex roots.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'date-is-leap-year': { cat: 'Date & Time', name: 'Is Leap Year', desc: 'Check whether a given year is a leap year.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'search-levenshtein': { cat: 'Text Processing', name: 'Levenshtein Distance', desc: 'Compute the Levenshtein edit distance between two strings.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'ml-sentiment': { cat: 'Analyze', name: 'ML Sentiment', desc: 'Word-based sentiment analysis returning positive/negative/neutral with score.', credits: CREDIT_COSTS.simple, tier: 'compute' },
  'validate-url': { cat: 'Validation', name: 'Validate URL', desc: 'Check if a URL is valid and parse its components.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  ...
  // ── Alias slugs: text ────────────────────────────────────────────────────────
  'text-slug': { cat: 'Text Processing', name: 'Text Slug', desc: 'Convert text to a URL-friendly slug.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-levenshtein': { cat: 'Text Processing', name: 'Levenshtein Distance', desc: 'Compute edit distance between two strings.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  'text-sentiment': { cat: 'Text Processing', name: 'Sentiment Analysis', desc: 'Detect positive/negative/neutral sentiment in text.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  ...
  // ── Alias slugs: math ────────────────────────────────────────────────────────
  'math-round': { cat: 'Math & Numbers', name: 'Round', desc: 'Round a number to a specified number of decimal places.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  ...
  'validate-uuid': { cat: 'Validation', name: 'Validate UUID', desc: 'Check if a string is a valid UUID.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
  ...
  // ── Alias slugs: date ────────────────────────────────────────────────────────
  'date-now': { cat: 'Date & Time', name: 'Date Now', desc: 'Return the current date and time in multiple formats.', credits: CREDIT_COSTS.trivial, tier: 'compute' },
};
