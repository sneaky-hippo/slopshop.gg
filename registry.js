...
const API_DEFS = {
  ...
  'convert-angle': { cat: 'Data Transform', name: 'Angle Convert', desc: 'Convert between angle units (degrees, radians, gradians).', credits: 0, tier: 'compute' },
  'convert-roman-numeral': { cat: 'Data Transform', name: 'Integer to Roman Numeral', desc: 'Convert an integer to Roman numeral notation.', credits: 0, tier: 'compute' },
  'convert-morse': { cat: 'Data Transform', name: 'Morse Code Convert', desc: 'Convert text to/from Morse code.', credits: 0, tier: 'compute' },
  'convert-csv-json': { cat: 'Data Transform', name: 'CSV to JSON', desc: 'Convert CSV data to JSON array of objects.', credits: 0, tier: 'compute' },
  'convert-yaml-json': { cat: 'Data Transform', name: 'YAML to JSON', desc: 'Convert simple YAML to JSON object.', credits: 0, tier: 'compute' },
  'convert-markdown-html': { cat: 'Data Transform', name: 'Markdown to HTML', desc: 'Convert Markdown text to HTML.', credits: 0, tier: 'compute' },
  ...
  'finance-discount': { cat: 'Finance', name: 'Discount Calculator', desc: 'Calculate discounted price given original price and discount percentage.', credits: 0, tier: 'compute' },
  'finance-margin': { cat: 'Finance', name: 'Margin Calculator', desc: 'Calculate profit margin given cost and selling price.', credits: 0, tier: 'compute' },
